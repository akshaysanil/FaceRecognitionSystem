...
# -----------------------  ktpy edited  ---------------------------- #
            ...
            if result_probability[detection_idx] >=0.80 and text_from_facenet is not None:
                ...
                text = 'Unknown' # recognition will happen only when the face probability  greateer than 87%.
