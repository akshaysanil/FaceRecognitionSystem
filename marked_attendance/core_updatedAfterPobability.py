...
# -----------------------  original code  ----------------------------
            ...
            #         # text = labels[1]
            #         print('inside the corefile of supervision ----- if : ',text)
            #     elif detections[CLASS_NAME_DATA_FIELD] is not None:
            #         text = detections[CLASS_NAME_DATA_FIELD][detection_idx]
            #         print('inside the corefile of supervision ----- text elif: ',text)

            #     elif detections.class_id is not None:
            #         text = str(detections.class_id[detection_idx])
            #         print('inside the corefile of supervision ----- text elif2 : ',text)

            #     else:
            #         text = str(detection_idx)
            #         print('inside the corefile of supervision ----- text else : ',text)
...
# -----------------------  ktpy edited  ----------------------------
            # text = text_from_facenet
            print('text from the facenet ----- : ',text)
